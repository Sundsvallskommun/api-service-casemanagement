...
class PlanningPermissionCaseDTOTest {
    ...
    @Test
    void testFields() {
        PlanningPermissionCaseDTO dto = TestUtil.createPlanningPermissionCaseDTO(CaseType.NYBYGGNAD_ANSOKAN_OM_BYGGLOV, (AttachmentCategory) TestUtil.getRandomOfEnum(AttachmentCategory.class));
