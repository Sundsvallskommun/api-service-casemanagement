...
class EnvironmentalCaseDTOTest {
    ...
    @Test
    void testFields() {
        EnvironmentalCaseDTO dto = TestUtil.createEnvironmentalCase(CaseType.REGISTRERING_AV_LIVSMEDEL, (AttachmentCategory) TestUtil.getRandomOfEnum(AttachmentCategory.class));
