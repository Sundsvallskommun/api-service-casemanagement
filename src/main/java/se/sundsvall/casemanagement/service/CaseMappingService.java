...
public class CaseMappingService {
    ...
    public CaseMapping getCaseMapping(String externalCaseId) throws ApplicationException {
        ...
        if (caseMappingList.isEmpty()) {
            ...
            throw new ApplicationException(MessageFormat.format("More than one case was found with the same externalCaseId: \"{0}\". This should not be possible.", externalCaseId));
        } else {
