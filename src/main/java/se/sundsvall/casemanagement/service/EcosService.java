...
public class EcosService {
    ...
    public EcosService(CitizenMappingService citizenMappingService, CaseMappingService caseMappingService, MinutMiljoClient minutMiljoClient, MinutMiljoClientV2 minutMiljoClientV2, FbService fbService) {
    ...
    private String createFoodFacility(EnvironmentalCaseDTO eCase, FbPropertyInfo propertyInfo, RegisterDocumentCaseResultSvcDto registerDocumentResult) throws ApplicationException {
        ...
        if (foodFacilityGuid != null) {
            ...
            throw new ApplicationException("FoodFacility could not be created.");
        }
    }

    private String createHeatPumpFacility(Map<String, String> facilityExtraParameters, FbPropertyInfo propertyInfo, RegisterDocumentCaseResultSvcDto registerDocumentResult) throws ApplicationException {
        ...
        if (facilityGuid != null) {
            ...
            throw new ApplicationException("HeatPumpFacility could not be created");
        }
    }
    ...
    private String createIndividualSewage(EnvironmentalFacilityDTO eFacility, FbPropertyInfo propertyInfo, RegisterDocumentCaseResultSvcDto registerDocumentResult) throws ApplicationException {
        ...
        if (facilityGuid != null) {
            ...
            throw new ApplicationException("Individual Sewage could not be created");
        }
    }
    ...
    public RegisterDocumentCaseResultSvcDto registerDocument(EnvironmentalCaseDTO eCase) throws ApplicationException {
        ...
        if (registerDocumentResult == null) {
            throw new ApplicationException("Case could not be created.");
        }
    ...
    private String getProcessTypeId(CaseType caseType) throws ApplicationException {
        return switch (caseType) {
    ...
    private void createParty(Map<String, ArrayOfguid> partyRoles, List<PartySvcDto> partyList, List<StakeholderDTO> missingStakeholderDTOS) throws ApplicationException {
    ...
    private void populatePartyList(EnvironmentalCaseDTO eCase, Map<String, ArrayOfguid> partyRoles, List<PartySvcDto> partyList, List<StakeholderDTO> missingStakeholderDTOS) throws ApplicationException {
    ...
    private void validate(EnvironmentalCaseDTO eCase) {
    ...
    ArrayOfguid getEcosFacilityRoles(StakeholderDTO s) throws ApplicationException {
    ...
    public CaseStatusDTO getStatus(String caseId, String externalCaseId) {
        ...
        if (ecosCase != null
            ...
            caseStatusDTO.setCaseId(ecosCase.getCaseNumber());
            List<CaseMapping> caseMappingList = caseMappingService.getCaseMapping(externalCaseId, caseId);
            ...
            OccurrenceListItemSvcDto latestOccurrence = listOfOccurrence.get(0);
            // Use the latest
            if (latestOccurrence.getOccurrenceDescription() != null) {
                caseStatusDTO.setStatus(latestOccurrence.getOccurrenceDescription());
                caseStatusDTO.setTimestamp(latestOccurrence.getOccurrenceDate());
    ...
    private String createHealthProtectionFacility(EnvironmentalFacilityDTO eFacility, FbPropertyInfo propertyInfo, RegisterDocumentCaseResultSvcDto registerDocumentResult) throws ApplicationException {
        ...
        if (facilityGuid != null) {
            ...
            throw new ApplicationException("Health Protection Facility could not be created");
        }
    }
