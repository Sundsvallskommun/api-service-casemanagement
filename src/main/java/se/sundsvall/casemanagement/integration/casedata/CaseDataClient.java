...
public interface CaseDataClient {
	...
	@GetMapping(path = "/attachments/errand/{errand_number}", produces = { APPLICATION_JSON_VALUE, APPLICATION_PROBLEM_JSON_VALUE })
	List<AttachmentDTO> getAttachmentsByErrandNumber(@PathVariable String errand_number);
